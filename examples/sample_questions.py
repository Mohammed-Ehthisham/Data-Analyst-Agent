"""
Sample questions for testing the Data Analyst Agent
"""

# Sample question 1: Wikipedia scraping
wikipedia_question = """Scrape the list of highest grossing films from Wikipedia. It is at the URL:
...
# Sample question 2: Database analysis
database_question = """The Indian high court judgement dataset contains judgements from the Indian High Courts, downloaded from [ecourts website](https://judgments.ecourts.gov.in/). It contains judgments of 25 high courts, along with raw metadata (as .json) and structured metadata (as .parquet).
...
# Save sample questions to files
sample_questions = {
    "wikipedia_question.txt": wikipedia_question,
    "database_question.txt": database_question
}
